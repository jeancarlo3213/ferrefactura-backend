"""
Django settings for FerreFac project.
...
SECRET_KEY = os.getenv('DJANGO_SECRET_KEY', 'una-clave-super-secreta')
...
MIDDLEWARE = [
    ...
    'corsheaders.middleware.CorsMiddleware',  # Añade CORS middleware para permitir peticiones CORS
